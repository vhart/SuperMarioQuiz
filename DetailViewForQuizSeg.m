...
@property (weak, nonatomic) IBOutlet UIButton *coolBackButton; // for button customization
...
- (void)viewDidLoad {
    ...
    self.coolBackButton.layer.cornerRadius = 10.0; // round button corners
    self.coolBackButton.layer.borderWidth = 3.0; // set border width
